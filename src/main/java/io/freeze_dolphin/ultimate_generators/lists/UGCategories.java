...
public class UGCategories {
	...
	public static Category SINGLE_GENERATOR = new Category(new CustomItem(new UniversalMaterial(Material.END_CRYSTAL), "&d终极发电机 &7- &b单体发电&r", "", "&7&oAuthor: Freeze_Dolphin", "&a > 点击打开"), 4);
	...
	public UGCategories(Loader plug) {
		...
		if (pdf.contains("hide-author-name-in-category") && pdf.isBoolean("hide-author-name-in-category") && pdf.getBoolean("hide-author-name-in-category")) {
			...
			SINGLE_GENERATOR = new Category(new CustomItem(new UniversalMaterial(Material.END_CRYSTAL), "&d终极发电机 &7- &b单体发电&r", "", "&a > 点击打开"), 4);
