...
public class UGItems {
        ...
        static {
                try {
                        ...
                        NETHER_STAR_GENERATOR = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 7),
                        ...
                        BIOMASS_EXTRACTION_MACHINE = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 5),
                        ...
                        BIOFUEL_BUCKET = new CustomItem(CustomSkull.getItem(
                                        ...
                                        "&r桶装生物燃油&r");
                        BIOFUEL_GENERATOR = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 4),
                                        "&2生物燃油发电机&r", "", "&6高级发电机", "&8⇨ &e⚡ &7256 J 缓存", "&8⇨ &e⚡ &736 J/s");

                        DRAGON_BREATH_GENERATOR = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 2),
                                        "&5龙息发电机&r", "", "&6高级发电机", "&8⇨ &e⚡ &7256 J 缓存", "&8⇨ &e⚡ &718 J/s");

                        REACTION_GENERATOR = new CustomItem(new UniversalMaterial(Material.STAINED_CLAY, 13),
                                        "&2反应发电机&r", "", "&r无需冷却的小型核反应发电机", "&r直接消耗低能核燃料发电", "&r但此发电方式的燃料利用率较低", "",
                                        "&6高级发电机", "&8⇨ &e⚡ &7256 J 缓存", "&8⇨ &e⚡ &716 J/s");

                        ENDER_CRYSTAL_GENERATOR = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 10),
                                        "&d末影水晶发电机&r", "", "&r连接并利用附近的强化末影水晶发电", "", "&4终极发电机", "&8⇨ &e⚡ &714336 J 缓存",
                                        "&8⇨ &e⚡ &70 ~ +∞ J/s");
                        ENDER_CRYSTAL_GENERATOR_BASE = new CustomItem(new UniversalMaterial(Material.END_BRICKS),
                                        "&b末影水晶发电机基座&r");
                        ...
                        BASIC_ELECTRICITY_STORAGE = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 4),
                        ...
                        PHI_ELECTRICITY_STORAGE = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS), Utils
                        ...
                        MAGNESIUM_GENERATOR = new CustomItem(new UniversalMaterial(Material.STAINED_CLAY, 8),
                                        "&f镁发电机&r", "", "&a中级发电机", "&8\u21E8 &e\u26A1 &7128 J 缓存",
                                        "&8\u21E8 &e\u26A1 &736 J/s");

                        QUANTUM_SOLAR_GENERATOR = new CustomItem(new ItemStack(Material.DAYLIGHT_DETECTOR),
                                        "&d量子太阳能发电机&r",
                                        new String[] { "", "&9可在夜晚发电", "", "&4终极发电机", "&8⇨ &e⚡ &765536 J 缓存",
                        ...
                        ENDER_LUMP_4 = new CustomItem(Material.GOLD_NUGGET, "&5末影结晶 &7- &eIV", 0,
                                        new String[] { "", "&c品级: IV" });
                        ...
                        HEAVY_WATER_BUCKET = new CustomItem(CustomSkull.getItem(
                                        ...
                                        "&f桶装重水&r");
                        HEAVY_WATER_REFINING_MACHINE = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 7),
                        ...
                        ItemStack itemRRG = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 2),
                        ...
                        GLASS_ELECTRICITY_TRANSMITTER = new CustomItem(new UniversalMaterial(Material.STAINED_GLASS, 9),
