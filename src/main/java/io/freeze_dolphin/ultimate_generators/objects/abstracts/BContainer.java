...
public abstract class BContainer extends SlimefunItem {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        preset.addItem(indicator, new CustomItem(new UniversalMaterial(Material.STAINED_GLASS_PANE, 15), " "), (arg0, arg1, arg2, arg3) -> false);
        ...
        if (displayMachineInfo) {
            preset.addItem(machineInfo, new CustomItem(new UniversalMaterial(Material.EMPTY_MAP), "&f机器信息", "&7 - &3耗电量: &e" + getEnergyConsumption() * 2 + " J/s", "&7 - &3工作速度: &e" + (getSpeed() == 1 ? "&f默认" : getSpeed())), (arg0, arg1, arg2, arg3) -> false);
        } else {
            preset.addItem(machineInfo, new CustomItem(new UniversalMaterial(Material.STAINED_GLASS_PANE, 7), " "), (arg0, arg1, arg2, arg3) -> false);
        }
    }
