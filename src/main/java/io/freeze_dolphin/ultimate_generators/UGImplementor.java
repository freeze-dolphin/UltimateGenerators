...
class UGImplementor {
        ...
        (new SlimefunItem(Categories.MAGIC, UGItems.REINFORCED_RAINBOW_GLASS, "REINFORCED_RAINBOW_GLASS",
                ...
                .register(false,
                        Boolean.parseBoolean(
                                DefaultConfig.getConfig("reinforced-rainbow-glass-twinkling-randomly"))
                                ? new ReinforcedRainbowTicker.Fancy()
                                : fast);

        Slimefun.addWikiPage("REINFORCED_RAINBOW_GLASS",
    ...
    public void implementMachines() {
         ...
         * }).registerChargeableBlock(false, 256);
         */
        (new SlimefunItem(UGCategories.ELECTRICITY_STORAGE, UGItems.GLASS_ELECTRICITY_TRANSMITTER,
                ...
                new CustomItem(UGItems.GLASS_ELECTRICITY_TRANSMITTER,
                        Integer.parseInt(
    ...
    public void implementSingleGenerators() {
        ...
        (new MagnesiumGenerator(UGCategories.SINGLE_GENERATOR, UGItems.MAGNESIUM_GENERATOR, "MAGNESIUM_GENERATOR",
                ...
                PlugGividado.getDisplaySw())).registerChargeableBlock(false, 128);
    ...
    public void implementModularGenerators() {
        ...
        (new EnderCrystalGenerator(UGCategories.MODULAR_GENERATOR, UGItems.ENDER_CRYSTAL_GENERATOR,
            ...
            public int getWarningCrystalNum() {
                return (Integer.parseInt(String.valueOf(PlugGividado.getProperties().get("warning-crystal-number"))));
            }
        ...
        (new RainbowGenerator(UGCategories.MODULAR_GENERATOR, UGItems.RAINBOW_REACTOR, "RAINBOW_REACTOR",
                RecipeType.ENHANCED_CRAFTING_TABLE,
