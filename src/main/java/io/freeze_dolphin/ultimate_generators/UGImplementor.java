...
class UGImplementor {
    ...
    public void implementIngredients() throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        ...
        (new SlimefunItem(UGCategories.DTechMisc, UGItems.SOLID_STORAGE_EXPANSION, RecipeType.ENHANCED_CRAFTING_TABLE,
                Utils.buildRecipe(null, SlimefunItems.CARGO_OUTPUT_NODE, SlimefunItems.ANDROID_INTERFACE_ITEMS, ALUI,
                        ALUI, mat(Material.GLASS), ALUI))).register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.DTechMisc, UGItems.LIQUID_STORAGE_EXPANSION, RecipeType.ENHANCED_CRAFTING_TABLE,
                Utils.buildRecipe(null, SlimefunItems.CARGO_OUTPUT_NODE, null, ALUI,
                        SlimefunItems.ANDROID_INTERFACE_FUEL, ALUI, ALUI, mat(Material.GLASS), ALUI)))
                                .register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.CStorage, UGItems.ELECTRICITY_STORAGE_UNIT, RecipeType.ENHANCED_CRAFTING_TABLE,
                Utils.buildRecipe(HGLASS, SlimefunItems.REDSTONE_ALLOY, HGLASS, ALUI, SlimefunItems.BATTERY, ALUI,
                        HGLASS, SlimefunItems.REDSTONE_ALLOY, HGLASS))).register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.CStorage, UGItems.ADVANCED_BATTERY, RecipeType.ENHANCED_CRAFTING_TABLE,
                Utils.buildRecipe(SlimefunItems.BATTERY, BCIRCUIT, SlimefunItems.BATTERY, COPPI, COPPI, COPPI,
                        SlimefunItems.BATTERY, BCIRCUIT, SlimefunItems.BATTERY))).register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.CStorage, UGItems.ALPHA_BATTERY, RecipeType.ENHANCED_CRAFTING_TABLE,
                Utils.buildRecipe(UGItems.ADVANCED_BATTERY, ACIRCUIT, UGItems.ADVANCED_BATTERY, COPPI,
                        ...
                        UGItems.ADVANCED_BATTERY))).register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.CStorage, UGItems.BETA_BATTERY, RecipeType.ENHANCED_CRAFTING_TABLE,
                Utils.buildRecipe(UGItems.ALPHA_BATTERY, ACIRCUIT, UGItems.ALPHA_BATTERY, COPPI,
                        ...
                        UGItems.ALPHA_BATTERY))).register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.CStorage, UGItems.GAMMA_BATTERY, RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new SlimefunItem(UGCategories.DRes, UGItems.DIESEL_BUCKET,
                new RecipeType(new CustomItem(Material.PISTON, "&c柴油精炼器&r", "&a在柴油精炼器里将石油精炼为柴油"), "DIESEL_REFINERY"),
                Utils.buildRecipe())).register(plug.getAddonHandle());
        (new SlimefunItem(UGCategories.DRes, UGItems.BIOMASS_BUCKET,
                new RecipeType(new CustomItem(Material.LIME_STAINED_GLASS, "&a生物质萃取机&r", "&a在生物质萃取机里提取一些作物中的生物质"),
                        "BIOMASS_EXTRACTION_MACHINE"),
                Utils.buildRecipe())).register(plug.getAddonHandle());
        (new SlimefunItem(UGCategories.DRes, UGItems.BIOFUEL_BUCKET,
                new RecipeType(new CustomItem(Material.PISTON, "&2生物燃油精炼器&r", "&a在生物燃油精炼器里将生物质精炼为生物燃油"),
                        "BIOFUEL_REFINERY"),
                Utils.buildRecipe())).register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.DMisc, UGItems.MAGNESIUM_SALT, RecipeType.PRESSURE_CHAMBER,
                Utils.buildRecipe(SlimefunItems.MAGNESIUM_DUST, SlimefunItems.MAGNESIUM_DUST,
                        Boolean.parseBoolean(DefaultConfig.getConfig("magnesium-salt-require-zinc-dust"))
                                ...
                                : null))).register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.DLAMagic, UGItems.ENDER_LUMP_4, RecipeType.ANCIENT_ALTAR,
        ...
        (new SlimefunItem(UGCategories.DLAMagic, UGItems.RUNE_COMPLEX_ENDER, RecipeType.ANCIENT_ALTAR,
                new ItemStack[] { SlimefunItems.ENDER_RUNE, SlimefunItems.GOLD_24K, SlimefunItems.ENCHANTMENT_RUNE,
                        UGItems.ENDER_LUMP_4, SlimefunItems.STONE_CHUNK, UGItems.ENDER_LUMP_4,
                        SlimefunItems.ENCHANTMENT_RUNE, SlimefunItems.GOLD_24K, SlimefunItems.ENDER_RUNE }))
                                .register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.DMisc, UGItems.ENDER_CRYSTAL_ENHANCER, RecipeType.ANCIENT_ALTAR,
                new ItemStack[] { mat(Material.GLASS), mat(Material.GLASS), mat(Material.GLASS), mat(Material.GLASS),
                        ...
                        mat(Material.GLASS) })).register(plug.getAddonHandle());

        // Then I wonder HOW TO ATTACH A WIKI PAGE on modern Slimefun 4 :(((((((((((
        // UGItems.ENDER_CRYSTAL_ENHANCER.getItem().addOficialWikipage(page);
        // Page("ENERGY_ACUMULATED_ENDER_CRYSTAL", "https
        // //gitee.com/freeze-dolphin/UltimateGenerators-wiki/blob/master/Generator-(Ender-Crystal-Generator).md");

        (new SlimefunItem(UGCategories.DRes, UGItems.HEAVY_WATER_BUCKET,
                new RecipeType(new CustomItem(Material.GRAY_STAINED_GLASS, "&7重水提炼机&r", "&a在重水提炼机里提取水中的重水"), ""),
                Utils.buildRecipe())).register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.DMisc, UGItems.NEUTRON_MODERATOR, RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new SlimefunItem(UGCategories.DTechMisc, UGItems.THERMAL_NEUTRON_REACTOR_COOLANT_CELL,
                RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] { null, null, UGItems.HEAVY_WATER_BUCKET, null,
                        SlimefunItems.REACTOR_COOLANT_CELL, null, UGItems.HEAVY_WATER_BUCKET, null, null }))
                                .register(plug.getAddonHandle());

        (new SlimefunItem(UGCategories.DRes, UGItems.RAINBOW_ALLOY, RecipeType.SMELTERY,
        ...
        SlimefunItem.getByItem(UGItems.REINFORCED_RAINBOW_GLASS)
                .addItemHandler(new ItemHandler[] {
                        Boolean.parseBoolean(DefaultConfig.getConfig("reinforced-rainbow-glass-twinkling-randomly"))
    ...
    public void implementMachines() {
        ...
        /*
         * (new BContainer(UGCategories.CMachine, UGItems.ENDERIUM_EXTRACTOR,
         ...
         * }).registerChargeableBlock(false, 256);
         */
        (new SlimefunItem(UGCategories.CStorage, UGItems.GLASS_ELECTRICITY_TRANSMITTER, "GLASS_ELECTRICITY_TRANSMITTER",
                RecipeType.ENHANCED_CRAFTING_TABLE,
                ...
                new CustomItem(UGItems.REINFORCED_RAINBOW_GLASS,
                        Integer.parseInt(
                                DefaultConfig.getConfig("glass-electricity-transmitter-crafting-number-on-once")))))
                                        .registerDistibutingCapacitor(false, 16);

        (new SlimefunItem(UGCategories.CStorage, UGItems.BASIC_ELECTRICITY_STORAGE, "BASIC_ELECTRICITY_STORAGE",
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] { SlimefunItems.BATTERY, SlimefunItems.REDSTONE_ALLOY, SlimefunItems.BATTERY,
                        ...
                        SlimefunItems.REDSTONE_ALLOY, SlimefunItems.BATTERY })).registerDistibutingCapacitor(false,
                                640);

        (new SlimefunItem(UGCategories.CStorage, UGItems.ADVANCED_ELECTRICITY_STORAGE, "ADVANCED_ELECTRICITY_STORAGE",
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new SlimefunItem(UGCategories.CStorage, UGItems.ALPHA_ELECTRICITY_STORAGE, "ALPHA_ELECTRICITY_STORAGE",
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new SlimefunItem(UGCategories.CStorage, UGItems.BETA_ELECTRICITY_STORAGE, "BETA_ELECTRICITY_STORAGE",
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new SlimefunItem(UGCategories.CStorage, UGItems.GAMMA_ELECTRICITY_STORAGE, "GAMMA_ELECTRICITY_STORAGE",
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new SlimefunItem(UGCategories.CStorage, UGItems.LAMBDA_ELECTRICITY_STORAGE, "LAMBDA_ELECTRICITY_STORAGE",
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new SlimefunItem(UGCategories.CStorage, UGItems.KAPA_ELECTRICITY_STORAGE, "KAPA_ELECTRICITY_STORAGE",
                UGRecipeType.NULL, new ItemStack[] {})).registerDistibutingCapacitor(false, 20971520);

        SlimefunStartup.getItemCfg().setValue("PHI_ELECTRICITY_STORAGE.hide-in-guide", true);
        (new SlimefunItem(UGCategories.CStorage, UGItems.PHI_ELECTRICITY_STORAGE, UGRecipeType.NULL,
                new ItemStack[] {})).registerDistibutingCapacitor(false, 167772160);

        (new BContainer(UGCategories.CMachine, UGItems.HEAVY_WATER_REFINING_MACHINE, RecipeType.ENHANCED_CRAFTING_TABLE,
    ...
    public void implementSingleGenerators() {
        ...
        (new SlimefunItem(UGCategories.SINGLE_GENERATOR, UGItems.ENDLESS_GENERATOR, UGRecipeType.NULL,
                Utils.buildRecipe(), true)).register(false, new EnergyTicker() {
        ...
        (new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.NETHER_STAR_GENERATOR,
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.DIESEL_GENERATOR, RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.BIOFUEL_GENERATOR, RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.DRAGON_BREATH_GENERATOR,
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.REACTION_GENERATOR, RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.COAL_GENERATOR, RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] { null, UGItems.SOLID_STORAGE_EXPANSION, null, ALUI, SlimefunItems.COAL_GENERATOR, ALUI,
        ...
        new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.BIO_REACTOR, RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] { null, UGItems.SOLID_STORAGE_EXPANSION, null, ALUI, SlimefunItems.BIO_REACTOR, ALUI,
                        null, UGItems.SOLID_STORAGE_EXPANSION, null },
                Loader.getDisplaySw()) {
        ...
        new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.LAVA_GENERATOR, RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] { null, UGItems.LIQUID_STORAGE_EXPANSION, null, ALUI, SlimefunItems.LAVA_GENERATOR,
                        ALUI, null, UGItems.LIQUID_STORAGE_EXPANSION, null },
                Loader.getDisplaySw()) {
        ...
        new BGenerator(UGCategories.SINGLE_GENERATOR, UGItems.COMBUSTION_REACTOR, RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] { null, UGItems.LIQUID_STORAGE_EXPANSION, null, ALUI, SlimefunItems.COMBUSTION_REACTOR,
                        ALUI, null, UGItems.LIQUID_STORAGE_EXPANSION, null },
                Loader.getDisplaySw()) {
        ...
        (new MagnesiumGenerator(UGCategories.SINGLE_GENERATOR, UGItems.MAGNESIUM_GENERATOR,
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new SlimefunItem(UGCategories.SINGLE_GENERATOR, UGItems.QUANTUM_SOLAR_GENERATOR,
                RecipeType.ENHANCED_CRAFTING_TABLE,
    ...
    public void implementModularGenerators() {
         ...
         * UGItems.ENDER_CRYSTAL_GENERATOR_BASE, RecipeType.ENHANCED_CRAFTING_TABLE,
         * Utils.buildRecipe( mat(Material.END_BRICKS), mat(Material.END_BRICKS),
         * mat(Material.END_BRICKS), mat(Material.END_BRICKS), UGItems.ENDERIUM_INGOT,
         * mat(Material.END_BRICKS), mat(Material.END_BRICKS),
         * SlimefunItems.HARDENED_METAL_INGOT,
         * mat(Material.END_BRICKS)))).register(plug.getAddonHandle());
         */
        (new AReactor(UGCategories.MODULAR_GENERATOR, UGItems.THERMAL_NEUTRON_REACTOR,
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        (new RainbowGenerator(UGCategories.MODULAR_GENERATOR, UGItems.RAINBOW_REACTOR,
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] { UGItems.RAINBOW_ALLOY, UGItems.REINFORCED_RAINBOW_GLASS, UGItems.RAINBOW_ALLOY,
        ...
        Slimefun.addWikiPage("RAINBOW_REACTOR",
                "https://gitee.com/freeze-dolphin/UltimateGenerators-wiki/blob/master/Generator-(Rainbow-Reactor).md");
